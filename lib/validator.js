...
var missingUploadsDirectory = function () {
...
exports.checkUploadsDirectory = function () {
    try {
        if (!fs.lstatSync(uploadPath).isDirectory() && !fs.lstatSync(uploadPath).isSymbolicLink()) {
